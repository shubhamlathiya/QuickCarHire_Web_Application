...
<div
    ...
    <div style="margin:50px auto;width:70%;padding:20px 0">
        ...
        <div
          ...
          <img src="cid:image_cid" alt="shubham" height="50" width="50">
          </div>
    </div>
</div>
</body>
            ...
            $sql1 = "INSERT INTO customer(Email, Password,otp,varify) VALUES ('$Emailid','$password','$otp','0')";
            try {
            ...
            echo "<script>window.location.href='otpVarification.php'</script>";
        }
    }
} else {
