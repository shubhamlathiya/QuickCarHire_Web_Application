...
<!--                                            <label for="Image">Image</label>-->
                                        ...
                                        <div class="d-grid gap-2">
                                            <input type="submit" name="Carupdate" id="Carupdate" class="btn btn-primary btn-lg"
                                                   value="Add Car">
                                        </div>
                                    </form>
                ...
                if (isset($_POST['Carupdate'])) {
                    ...
                    $UpdateCar->bind_param("ssssssis", $R_no, $Car_name, $Car_brand,$City, $Category_Id, $Car_Status, $Car_hire_cost, $Speed);
